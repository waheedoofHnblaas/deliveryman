            ...
            delegate: SliverChildBuilderDelegate(
              (BuildContext context, int index) {
                return InkWell(
                  onTap: () async {
                    AwesomeDialog(
                            ...
                            body: Column(
                              children: [
                                Text(
                                  'count of :${widget.getorderItems[index].name}',
                                  style: TextStyle(
                  ...
                  child: CustomItemCard(context, widget.getorderItems, index,
                      Container(), widget.getorderItems[index].count),
                );
              },
